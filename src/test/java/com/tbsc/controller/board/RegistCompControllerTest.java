...
public class RegistCompControllerTest {
    ...
    void test1() {
        ...
        for (Map<String, String> map : ma) {
            ...
            registComp.setWriter(members.get(i).getName());
